  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="navlink flex w-full justify-between items-center p-5">
          <div className="p-2">
          ...
          >
            <div className="h-44 w-1 absolute -rotate-45 origin-top bg-[#D3FD50]"></div>
            <div className="h-44 w-1 right-0 absolute rotate-45 origin-top bg-[#D3FD50]"></div>
          </div>
        </div>
        <div id="all-Links" className="py-5">
